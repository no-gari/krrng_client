                      ...
                      return Container(
                        ...
                        decoration: BoxDecoration(
                            image: DecorationImage(
                                image: CachedNetworkImageProvider(imageList[itemIndex]!),
                                fit: BoxFit.cover)),
                        );
                      }
                  ),
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: TextButton(
                        ...
                        child: Text("${this.index+1}/${imageList.length}", style: font_12_w500.copyWith(color: Colors.white)),
                      ),
                    ),
                  ),
                ],
                ...
                children: [
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Row(children: [
                      ...
                      Text(review.diagnosis!, style: TextStyle(fontSize: 15))
                    ]),
                    Padding(
                  ...
                  SizedBox(height: 20),
                  Row(children: [
                    SvgPicture.asset('assets/icons/like_on.svg'),
                    SizedBox(width: 10),
                    Text.rich(TextSpan(style: TextStyle(fontSize: 15),
                        children: [
                          TextSpan(text: review.likes!.toString() + '명이 ', style: TextStyle(fontWeight: FontWeight.bold, color: primaryColor)),
