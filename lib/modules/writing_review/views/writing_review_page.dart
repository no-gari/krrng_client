...
class _WritingReviewPageState extends State<WritingReviewPage> {
  ...
  Future getReviewImages() async {
    List<Asset> resultList = <Asset>[];
    resultList = await MultiImagePicker.pickImages(
        maxImages: 10, enableCamera: true, selectedAssets: _reviewImages);
    setState(() {
          ...
          Flexible(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("${hospital.address} ${hospital.addressDetail}",
                      style: font_15_w500),
                ],
              )),
          Flexible(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text("해당 병원에서 진료 받으신 항목명을 입력해 주세요.",
              style: font_14_w500.copyWith(height: 1.5)),
          const SizedBox(height: 14),
          TextFormField(
              controller: diseaseController,
              validator: (text) =>
                  (text ?? "").length == 0 ? '진료 항목을 입력해주세요.' : null,
              obscureText: false,
          ...
          children: [
            ...
            GestureDetector(
                onTap: () => Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (_) =>
                            ReviewNoticePage(code: ReviewNotice.receipt))),
                child: SvgPicture.asset("assets/icons/report.svg", width: 20))
          ],
        ),
        Text("해당 병원에서 진료 받으신 영수증을 첨부해 주세요.",
            style: font_14_w500.copyWith(height: 1.5)),
        // 영수증 썸네일 리스트 뷰
        Container(
                          ...
                          decoration: index == 0
                              ...
                              : thumbnailDecoration.copyWith(
                                  image: DecorationImage(
                                      ...
                                      fit: BoxFit.cover)),
                          child: index == 0
                              ? Icon(Icons.add, color: dividerColor)
                              : IconButton(
                                  onPressed: () {
                                    setState(() {
                ...
                children: [
                  ...
                  GestureDetector(
                      onTap: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (_) => ReviewNoticePage(
                                  code: ReviewNotice.hospital))),
            ...
            child: Stack(
              children: [
                TextFormField(
                  ...
                  maxLines: null,
                  decoration:
                      baseInputDecoration("병원리뷰를 10자이상 입력해 주세요.\n(최대 500자)")
                          .copyWith(
                    contentPadding: _reviewImages.length == 0
                        ? EdgeInsets.fromLTRB(15, 14, 15, 44)
                        : EdgeInsets.fromLTRB(15, 14, 15, 160),
                  ),
                ),
                _reviewImages.length > 0
                    ? Positioned(
                        bottom: 20,
                        left: 0,
                        child: Container(
  ...
  Widget _Information() {
    return Padding(
      ...
      child: Column(
        children: [
          Text("검수가 완료되면, 작성일 기준 차주 화요일에 포인트가 일괄 적립됩니다. (공휴일인 경우, 익일 적립)",
              style: font_14_w500.copyWith(height: 1.5)),
          const SizedBox(height: 10),
          Text("정보가 일치하지 않거나, 부적할 리뷰인 경우 포인트가 지급되지 않으며, 리뷰가 블라인드 처리될 수 있습니다.",
              style: font_14_w500.copyWith(height: 1.5, color: primaryColor)),
          const SizedBox(height: 30),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Row(
                children: [
                  IconButton(
                      ...
                      icon: terms[0]
                          ? SvgPicture.asset('assets/images/checkBox_on.svg')
    ...
    return Wrap(
      children: [
        IconButton(
            ...
            icon: rates >= 1
                ? SvgPicture.asset("assets/icons/reviewOn.svg")
                : SvgPicture.asset("assets/icons/reviewOff.svg"),
            padding: EdgeInsets.zero,
