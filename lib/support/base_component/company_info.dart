import 'package:krrng_client/support/base_component/web_router.dart';
              ...
              Row(children: [
                GestureDetector(
                    onTap: () => isWebRouter(context,
                        'https://www.instagram.com/krrng_client_official/'),
              ...
              text: TextSpan(
                ...
                WidgetSpan(
                    child: GestureDetector(
                        onTap: () => isWebRouter(context,
                            'https://krrng_client.co/personal_policy/'),
                ...
                WidgetSpan(
                    child: GestureDetector(
                  onTap: () => isWebRouter(
                      context, 'https://krrng_client.co/agreement/'),
                  child: Text('서비스 이용약관',
                      style: theme.textTheme.bodyText2!.copyWith(
                          color: theme.primaryColor,
                          fontWeight: FontWeight.bold,
